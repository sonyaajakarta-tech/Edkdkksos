...
local function launchMainScript()
	...
	-- ============================================================
	-- FARM PAGE — AUTO FARM MARSHMALLOW (DeepSeek ported)
	-- ============================================================
	_buildFarm = function()
		...
		Instance.new("UICorner", farmBar).CornerRadius = UDim.new(0, 8)
		...
		farmDot.Position = UDim2.new(0, 12, 0.5, -4)
		...
		farmNameLbl.Position = UDim2.new(0, 26, 0, 0)
		...
		farmPill.Size = UDim2.new(0, 46, 0, 22)
		farmPill.Position = UDim2.new(1, -54, 0.5, -11)
		farmPill.BackgroundColor3 = Color3.fromRGB(20, 26, 45)
		...
		local function refreshFarmBar()
			local on = FarmActive
			farmBar.BackgroundColor3 = on and Color3.fromRGB(18, 26, 50) or T.Card
			...
			farmPill.BackgroundColor3 = on and T.AccOn or Color3.fromRGB(20, 26, 45)
		...
		local function CookAndPackRobust(batchNum)
			if not FarmActive then return end
			setFarmStatus(("Masak #%d — Water..."):format(batchNum), Color3.fromRGB(0,170,255))
			local wSuccess = robustPutIngredient({"Water", "Water23"}, 23)
			if not wSuccess then return end
			setFarmStatus(("Masak #%d — Sugar..."):format(batchNum), Color3.fromRGB(0,170,255))
			robustPutIngredient("Sugar Block Bag", 0)
			setFarmStatus(("Masak #%d — Gelatin..."):format(batchNum), Color3.fromRGB(0,170,255))
