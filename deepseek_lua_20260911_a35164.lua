-- Cleaned version of Strix Hub Key System
-- Removed all anti-deobfuscation and obfuscation layers
...
local DISCORD_INVITE = "https://discord.gg/xKvegCV6yf"
...
local function showBlockGui()
    ...
    screenGui.Name = "StrixGameBlockGui"
    ...
    title.Text = "STR HUB | EXECUTION BLOCKED"
...
local function showKeyGui()
    local screenGui = Instance.new("ScreenGui")
    screenGui.Name = "StrixSecureKeySystem"
    screenGui.ResetOnSpawn = false
    screenGui.IgnoreGuiInset = true
    screenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
