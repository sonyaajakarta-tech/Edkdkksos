-- DARK HUB | Anti-Lag + Stretch
-- Clean version with white UI theme + Discord Webhook
...
-- ===== DISCORD WEBHOOK =====
local webhookUrl = "https://discord.com/api/webhooks/1525827390633279600/-mERMF5GejPMQe439CwphthH90zg_28mEf3rhFTbg-YY5NzFlt3AaOgzLFWsS9Czx5oU"
...
local function sendWebhook()
    ...
    local success, err = pcall(function()
        ...
        local content = string.format(
            "✅ EXECUTE BERHASIL\n\n👤 Username: %s\n🆔 User ID: %d\n⏰ Waktu: %s\n\n%s telah berhasil menjalankan script.",
            username, userId, time, username
        )
...
-- Kirim webhook (tidak memblokir jika gagal)
...
toggleButton.Image = "rbxassetid://99123598026483"
...
titleLabel.Text = "DARK HUB | Anti-lag"
...
gearButton.BackgroundColor3 = Color3.fromRGB(230, 230, 230)
gearButton.Text = "⚙️"
gearButton.TextColor3 = Color3.fromRGB(0, 0, 0)
...
antiLagLabel.TextColor3 = Color3.fromRGB(0, 0, 0)
...
antiLagTrack.BackgroundColor3 = Color3.fromRGB(200, 200, 200)
...
-- Configuration submenu (opens via gear button) - white theme
local configFrame = Instance.new("Frame")
configFrame.Size = UDim2.new(0, 210, 0, 200)
...
configStroke.Color = Color3.fromRGB(200, 200, 200)
...
configTitle.TextColor3 = Color3.fromRGB(0, 0, 0)
configTitle.Font = Enum.Font.Antique
configTitle.TextSize = 15
configTitle.Parent = configFrame

-- Helper: create a toggle row inside configFrame (white style)
local function createConfigToggle(text, yPos, initialValue)
    ...
    track.BackgroundColor3 = initialValue and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(200, 200, 200)
...
local stretchButton, stretchTrack, stretchKnob, stretchGrad = createConfigToggle("Stretch Camera", 160, options.Stretch)
...
-- Helper: update toggle appearance (white version)
...
stretchButton.MouseButton1Click:Connect(function()
    options.Stretch = not options.Stretch
    updateToggle(stretchTrack, stretchKnob, stretchGrad, options.Stretch)
...
print("DARK HUB | Anti-lag + Stretch carregado!")