-- ============================================================
-- DARK HUB | Cali Streets (Baselined UI)
-- by @strixwashere (converted to Baselined)
-- ============================================================

-- Load Baselined UI Library
...
local function AutoFarmLoop()
    while AutoFarmRunning do
        ...
        -- Step 1: Go to first spot and interact
        ...
        -- Step 2: Go to two positions and use "blank" card
        local positions = {
        ...
        -- Step 4: Go to another spot and use "activated" card
        ...
        if char then
            for _, tool in ipairs(char:GetChildren()) do
                if tool:IsA("Tool") then
                    table.insert(inv, tool.Name .. " (Equipped)")
                end
            end
        end
...
-- Socials Tab
-- ============================================================
SocialsTab:AddSection({ Text = "Community" })

SocialsTab:AddParagraph({
    Title = "Discord Server",
    Text = "If you aren't in the discord server, please join!"
})
...
SocialsTab:AddParagraph({
    ...
    Text = "Subscribe to my channel with notifications on to support me!"
})
...
-- Credits Tab
-- ============================================================
CreditsTab:AddSection({ Text = "Credits" })
...
SettingsTab:AddSection({ Text = "UI Settings" })
...
SettingsTab:AddButton({
    ...
    Callback = function()
        ...
        task.wait(2)
        -- Optional: destroy the UI completely
...
-- ============================================================
-- Game Loop (Heartbeat) - same as before
-- ============================================================
...
RunService.Heartbeat:Connect(function()
    ...
    -- Infinite Stamina (by modifying attributes and values)
...
-- ============================================================
Window:Notify({
    Text = "DARK HUB Loaded successfully!",
    Duration = 4
})