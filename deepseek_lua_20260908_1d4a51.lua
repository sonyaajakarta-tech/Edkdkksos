...
-- Clean version with white UI theme
...
toggleButton.Image = "rbxassetid://135237853751876"
...
configFrame.Size = UDim2.new(0, 210, 0, 200)  -- taller for new toggle
...
-- Create toggles in config frame (add stretch at y=160)
